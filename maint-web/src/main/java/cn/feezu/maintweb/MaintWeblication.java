...
@EnableAsync
public class MaintWeblication extends WebMvcConfigurerAdapter {
	private static final Logger log = LoggerFactory.getLogger(MaintWeblication.class);
	
	public static void main(String[] args) throws BeansException, Exception{
		ConfigurableApplicationContext  content = new SpringApplication(MaintWeblication.class).run(args);
