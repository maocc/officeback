...
public class OrderOperateExample extends AbstractExample {

    protected boolean distinct;

    protected List<Criteria> oredCriteria;

    public OrderOperateExample() {
        oredCriteria = new ArrayList<Criteria>();
    }
    public OrderOperateExample(Pageable pageable) {
    	super(pageable);
        oredCriteria = new ArrayList<Criteria>();
    }
    ...
    public static class Criteria extends GeneratedCriteria {
        private OrderOperateExample example;

        protected Criteria(OrderOperateExample example) {
            super();
            this.example = example;
        }

        public OrderOperateExample example() {
            return this.example;
        }
    }
