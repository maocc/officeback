...
@XmlType(name = "result", namespace="authority", propOrder = {
    "errors",
    "returnValue",
    "maintUserDTO"
})
    ...
    extends BaseResult
{
    ...
    protected UserDTO returnValue;
    
    private MaintUserDTO maintUserDTO;
     ...
     *     
     */
    public void setReturnValue(UserDTO value) {
        this.returnValue = value;
    }

	public MaintUserDTO getMaintUserDTO() {
		return maintUserDTO;
	}

	public void setMaintUserDTO(MaintUserDTO maintUserDTO) {
		this.maintUserDTO = maintUserDTO;
	}
